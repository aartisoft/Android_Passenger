...
public class HailedRegoCheckAsyncTask extends AsyncTask<String, Void, Void> {
	...
	public HailedRegoCheckAsyncTask(Activity activity, OnRequestComplete callback2) {
	...
	protected Void doInBackground(String... params) {
		...
		String id = params[1];
		String rego_id = params[2];
		try {
			responseStatus = CommunicationLayer.getHailedRegoCheck(func_id, id, rego_id);
		} catch (Exception e) {
			e.printStackTrace();
		}
