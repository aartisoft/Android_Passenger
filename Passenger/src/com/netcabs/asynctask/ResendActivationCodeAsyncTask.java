...
public class ResendActivationCodeAsyncTask extends AsyncTask<String, Void, Void> {
	...
	public ResendActivationCodeAsyncTask(Activity activity, OnRequestComplete callback2) {
