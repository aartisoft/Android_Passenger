...
public class SendAndSeenAsyncTask extends AsyncTask<String, Void, Void> {
	...
	public SendAndSeenAsyncTask(Activity activity, OnRequestComplete callback2) {
	...
	protected Void doInBackground(String... params) {
		...
		try {
			responseStatus = CommunicationLayer.getSendAndSeen(func_id, id, booking_id);
		} catch (Exception e) {
			e.printStackTrace();
		}
