...
public class FavoriateListAsyncTask extends AsyncTask<String, Void, Void> {
	...
	public FavoriateListAsyncTask(Activity activity, OnRequestComplete callback2) {
	...
	protected Void doInBackground(String... params) {
		...
		try {
			responseStatus = CommunicationLayer.getFavouriteDestinationList(func_id, id, type);
		} catch (Exception e) {
			e.printStackTrace();
		}
