...
public class ShareTripAsyncTask extends AsyncTask<String, Void, Void> {
	...
	public ShareTripAsyncTask(Activity activity, OnRequestComplete callback2) {
	...
	protected Void doInBackground(String... params) {
		...
		try {
			responseStatus = CommunicationLayer.getShareTrip(func_id, id, booking_id);
		} catch (Exception e) {
			e.printStackTrace();
		}
