...
public class LostPasswordAsyncTask extends AsyncTask<String, Void, Void> {
	...
	public LostPasswordAsyncTask(Activity activity, OnRequestComplete callback2) {
	...
	protected Void doInBackground(String... params) {
		...
		try {
			responseStatus = CommunicationLayer.getLostPasswordData(func_id, emailAddress);
		} catch (Exception e) {
			e.printStackTrace();
		}
