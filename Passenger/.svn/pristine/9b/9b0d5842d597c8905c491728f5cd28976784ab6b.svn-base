...
public class PastBookingDetailsAsyncTask extends AsyncTask<String, Void, Void> {
	...
	public PastBookingDetailsAsyncTask(Activity activity, OnRequestComplete callback2) {
	...
	protected Void doInBackground(String... params) {
		...
		try {
			responseStatus = CommunicationLayer.getPastBookingDetails(func_id, id, booking_id);
		} catch (Exception e) {
			e.printStackTrace();
		}
